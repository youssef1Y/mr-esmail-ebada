...
import { BookOpen, ChevronRight, CheckCircle, XCircle, RotateCcw, Library, Filter, Trophy, Target, Zap, ArrowLeft } from "lucide-react";
...
const QuestionBank = () => {
  ...
  const startPractice = async () => {
    ...
    // Use RPC for randomized questions
          ...
          {!started ? (
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-muted-foreground">اختر المادة والدرس وابدأ التدريب على أسئلة عشوائية</p>
              </div>
              ...
              <div className="bg-card rounded-2xl border-2 border-primary/30 p-6 text-center">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="bg-background rounded-xl p-3 border border-border">
                    <div className="text-lg font-bold text-primary">{Math.round((score / total) * 100)}%</div>
