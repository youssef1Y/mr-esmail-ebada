...
const faqs = [
  ...
  },
  {
    ...
    answer: "يتم تدريس الفقه الإسلامي بمذاهبه الثلاثة (الشافعي والمالكي والحنفي)، والتوحيد، وتفسير القرآن الكريم، والحديث النبوي الشريف، والسيرة النبوية (للمرحلة الإعدادية). جميع المواد مطابقة للمنهج الأزهري المقرر.",
  },
  {
