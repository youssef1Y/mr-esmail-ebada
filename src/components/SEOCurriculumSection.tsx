...
const curriculumDetails = [
  ...
  },
  {
    title: "النحو والصرف",
    description:
      "تعلم قواعد اللغة العربية والنحو والصرف وفق المنهج الأزهري. يشمل الشرح: أقسام الكلام، الإعراب والبناء، المرفوعات والمنصوبات والمجرورات، النواسخ، التوابع، وأحكام الصرف. مع تدريبات وتطبيقات عملية لتثبيت القواعد.",
  },
];
